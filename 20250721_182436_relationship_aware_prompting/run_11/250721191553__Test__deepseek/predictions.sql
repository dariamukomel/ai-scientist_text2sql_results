...
SELECT DISTINCT direction FROM vacancies WHERE direction IS NOT NULL
...
SELECT vacancy_id, name, salary_from, salary_to, salary_currency FROM vacancies WHERE salary_currency = 'USD'
