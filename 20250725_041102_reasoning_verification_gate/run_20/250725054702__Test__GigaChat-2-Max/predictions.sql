...
SELECT vacancies.work_location, COUNT(*) as count_vacancies FROM vacancies WHERE vacancies.name LIKE '%Python%' GROUP BY vacancies.work_location ORDER BY count_vacancies DESC LIMIT 1;
