...
SELECT      work_location AS "Город",     MAX(salary_to) AS "Максимальная зарплата" FROM      vacancies WHERE      work_location IN ('Москва', 'Омск', 'Екатеринбург')     AND date_added >= '2022-10-01'     AND date_added < '2022-11-01' GROUP BY      work_location;
