...
SELECT *  FROM vacancies  WHERE salary_from BETWEEN 50000 AND 100000  AND salary_currency = 'RUR';
...
SELECT DISTINCT vacancies.name AS job_title FROM vacancies JOIN companies ON vacancies.company_id = companies.company_id WHERE companies.name = 'ООО Ништяк';
