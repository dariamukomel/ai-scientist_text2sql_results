...
SELECT v.name AS "Название вакансии", c.name AS "Компания" FROM vacancies v JOIN companies c ON v.company_id = c.company_id WHERE c.company_city = 'Санкт-Петербург' AND v.direction = 'bigdata';
